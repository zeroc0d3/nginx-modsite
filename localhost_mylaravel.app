# Configuration without domain "mylaravel.app" 
# using default nameserver as localhost (127.0.0.1)
...
server {
    ...
    root            /home/zeroc0d3/repos;

    # Point index to the Laravel front controller.
    index           index.php index.html index.htm;

    location /mylaravel.app/ {
    ...
    location @rewrites {
	      rewrite ^ /mylaravel.app/public/index.php last;
    }
